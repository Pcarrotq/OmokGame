package chatting.test2.controller;

import java.util.ArrayList;
import javax.swing.*;

import chatting.test2.client.datacommunication.ClientSocket;
import chatting.test2.client.frame.ErrorMessagePanel;
import chatting.test2.client.frame.IndexPanel;
import chatting.test2.client.frame.MainPanel;
import chatting.test2.server.userdb.User;
import chatting.test2.server.userdb.UserDAO;
