...
import chatting.test2.enums.CommonWord;
import chatting.test2.util.UserInfoPanel;
...
public class LoginPanel extends UserInfoPanel {
  ...
  public void writeUserInfo() {
    ...
    for (CommonWord commonWord : CommonWord.values()) {
      if (commonWord.getNum() == CommonWord.EMAIL.getNum() || commonWord.getNum() == CommonWord.PASSWORD.getNum()) {
